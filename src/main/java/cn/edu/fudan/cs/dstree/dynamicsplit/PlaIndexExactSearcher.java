 ...
 */
public class PlaIndexExactSearcher {
    //classic exactFile
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        String indexPath = "G:\\dstree_data\\Series_64_1000000.z.1.txt.idx_dyn_pla3_100_1";
...
//            System.out.println("node path and lowerBound");

//                        while (node != null)
//            {
//                System.out.println("node.getFileName() = " + node.getFileName());
//                double plaLowerBound = DistTools.plaLowerBound(node, queryTs);
//                System.out.println("plaLowerBound = " + plaLowerBound);
//                node = node.parent;
//            }
    ...
    public static Node exactSearch(double[] queryTs, Node root) throws IOException {
        ...
        tempItem.node = root;
//        tempItem.dist = DistTools.pla2LowerBound(root, queryTs);
        tempItem.dist = DistTools.pla3LowerBound(root, queryTs);
        pq.add(tempItem);
...
//            System.out.println("minPqItem.node.isTerminal() = " + minPqItem.node.isTerminal());
...
//                tempItem.dist = DistTools.pla2LowerBound(tempItem.node, queryTs);
                tempItem.dist = DistTools.pla3LowerBound(tempItem.node, queryTs);
//                System.out.println("tempItem.node.getFileName() = " + tempItem.node.getFileName());
//                System.out.println("tempItem.dist = " + tempItem.dist);
