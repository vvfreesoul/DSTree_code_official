...
//        current.lowBound = Math.max(DistTools.lowerBoundByAvgAndStd(node, queryTs), parent_low);
//        current.uppBound = Math.min(DistTools.upperBoundByAvgAndStd(node, queryTs), parent_upp);

        current.lowBound = Math.max(DistTools.pla2LowerBound(node, queryTs), parent_low);
        current.uppBound = Math.min(DistTools.pla2UpperBound(node, queryTs), parent_upp);
