...
public class Pla3IndexBuilder {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String fileName = "G:\\dstree_data\\Series_64_1000000.z.1.txt";
        if (args.length > 0)
            fileName = args[0];
...
//        int maxTsCount = 10000;
    ...
    public static void buildIndex(String fileName, String indexPath, int threshold, int segmentSize, double bufferedMemorySize, int maxTsCount) throws IOException, ClassNotFoundException {
        ...
        if (indexPath == null)
            indexPath = fileName;
        indexPath = indexPath + ".idx_dyn_pla3";
        ...
        //for pla2
        INodeSegmentSplitPolicy[] nodeSegmentSplitPolicies = new INodeSegmentSplitPolicy[3];
//        nodeSegmentSplitPolicies[0] = new SlopeNodeSegmentSplitPolicy();
        nodeSegmentSplitPolicies[0] = new PlaLeftNodeSegmentSplitPolicy();
//        nodeSegmentSplitPolicies[1] = new InterceptNodeSegmentSplitPolicy();
        nodeSegmentSplitPolicies[1] = new PlaRightNodeSegmentSplitPolicy();
        nodeSegmentSplitPolicies[2] = new SseNodeSegmentSplitPolicy();

        root.setNodeSegmentSplitPolicies(nodeSegmentSplitPolicies);

        ISeriesSegmentSketcher seriesSegmentSketcher = new PlaSeriesSegmentSketcher();
        root.setSeriesSegmentSketcher(seriesSegmentSketcher);
        root.setNodeSegmentSketchUpdater(new PlaNodeSegmentSketchUpdater(seriesSegmentSketcher));

        root.setRange(new Pla3Range());
