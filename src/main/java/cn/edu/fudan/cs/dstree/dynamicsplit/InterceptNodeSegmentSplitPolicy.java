 ...
 */
public class InterceptNodeSegmentSplitPolicy implements INodeSegmentSplitPolicy {
    public NodeSegmentSketch[] split(NodeSegmentSketch nodeSegmentSketch) {
        float max_intercept = nodeSegmentSketch.indicators[0];                //todo
        float min_intercept = nodeSegmentSketch.indicators[1];
        indicatorSplitValue = (max_intercept + min_intercept) / 2;  //the mean value is split value
