 ...
 */
public class PaaPlaIndexBuilder {
    /**
...
//        int maxTsCount = 10000;
    ...
    public static void buildIndex(String fileName, String indexPath, int threshold, int segmentSize, double bufferedMemorySize, int maxTsCount) throws IOException, ClassNotFoundException {
        ...
        if (indexPath == null)
            indexPath = fileName;
        indexPath = indexPath + ".idx_dynpla";
        ...
        ISeriesSegmentSketcher seriesSegmentSketcher = new PaaPlaSeriesSegmentSketcher();
        root.setSeriesSegmentSketcher(seriesSegmentSketcher);
        root.setNodeSegmentSketchUpdater(new PaaPlaNodeSegmentSketchUpdater(seriesSegmentSketcher));
